<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-table fa-fw "></i> Pages <span> > List </span>
        </h1>
    </div>
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="/admin/pages/page/create">Add New</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <span class="pagination">
                        <div class="input-group">
                            <select id="bulk-actions" name="bulk_action" class="form-control">
                                ...
                                <option value="delete" data-action="/admin/pages/pages/delete">Delete</option>
                            </select>
            ...
            <table class="table table-striped table-bordered table-hover table-highlight table-checkable">
                ...
                <?php if (!empty($paginated->items)) { ?>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <h5>
                                <a href="/admin/pages/page/edit/<?php echo $item->id; ?>">
                            <?php echo $item->title; ?>
                            </a>
                            </h5>
                        ...
                        <td class="text-center"><a class="btn btn-xs btn-secondary" href="/admin/pages/page/edit/<?php echo $item->id; ?>">
                                <i class="fa fa-pencil"></i>
                            </a> &nbsp; <a class="btn btn-xs btn-danger" data-bootbox="confirm" href="/admin/pages/page/delete/<?php echo $item->id; ?>">
