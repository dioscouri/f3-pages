<article id="page-<?php echo $item->id; ?>" class="page-<?php echo $item->id; ?>">
        ...
        <div class="entry-meta lead">
            ...
            <span class="byline">
                <span class="author vcard">
                    <a class="url fn n" href="./pages/author/<?php echo $item->{'metadata.creator.id'}; ?>" title="View all pages by <?php echo $item->{'metadata.creator.name'}; ?>" rel="author"><?php echo $item->{'metadata.creator.name'}; ?></a>
                </span>
            </span>
            /
    ...
    <div class="entry-meta">
        ...
        <p class="cat-links">
            ...
            <a class="label label-primary" href="./pages/category/<?php echo $category['slug']; ?>" title="View all pages in <?php echo $category['title']; ?>" rel="category tag"><?php echo $category['title']; ?></a>
            <?php } ?>
        </p>
        <?php } ?>
    ...
    <div class="social-shares clearfix">
        ...
        <div class="">
            <ul class="list-unstyled list-inline">
                ...
                <li>
                    <a href="http://www.myspace.com/Modules/PageTo/Pages/?u=http://themes.goodlayers2.com/ideo/egestas-tellus-sit-dolor/" target="_blank">
